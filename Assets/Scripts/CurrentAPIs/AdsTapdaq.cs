...
public class AdsTapdaq : MonoBehaviour {
...
//		{
//			GlobalEvents<OnAdsRewardedLoaded>.Call(
//				new OnAdsRewardedLoaded {IsAvailable = true});
//		}
//	}
//	
...
//			GlobalEvents<OnAdsRewardedLoaded>.Call(
//				new OnAdsRewardedLoaded {IsAvailable = false});
...
//	}
//
//	private void ShowVideo(OnAdsVideoShow e)
//	{
...
//	}
//
//	private void ShowRewarded(OnAdsRewardedShow e)
//	{
//		if (AdManager.IsRewardedVideoReady("rewarded")) {
//			AdManager.ShowRewardVideo("rewarded");
////			Defs.MuteSounds (true);
//			
//			// Запускаем таймер ожидания следующей Ревардед рекламы
